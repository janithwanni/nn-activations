...
def generate_xy(n_samples, space_params, rng, mode):
    ...
    """
    if mode == "uniform":
        x = rng.uniform(space_params["x_lower"], space_params["x_upper"], n_samples)
        y = rng.uniform(space_params["y_lower"], space_params["y_upper"], n_samples)
